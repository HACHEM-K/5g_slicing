...
thread_ue1 = threading.Thread(target=run_iperf, args=("rfsim5g-oai-nr-ue1", "192.168.70.145", "12.1.1.133", 5001, output_ue1, "UE 1"))
thread_ue2 = threading.Thread(target=run_iperf, args=("rfsim5g-oai-nr-ue2", "192.168.70.145", "12.1.1.134", 5001, output_ue2, "UE 2"))
thread_ue3 = threading.Thread(target=run_iperf, args=("rfsim5g-oai-nr-ue3", "192.168.70.145", "12.1.1.135", 5001, output_ue3, "UE 3"))
